...
MANUAL_ROI_START_Y = 400  # Y coordinate where the ROI starts
MANUAL_ROI_WIDTH = 500    # The width of the ROI
MANUAL_ROI_HEIGHT = 120    # The height of the ROI
...
def convert_to_mm(x, y, roi_coords):
    # Calculate the section based on x-coordinate
    section_width = MANUAL_ROI_WIDTH // 3
    if x < section_width:
...
significant_points_mm = [convert_to_mm(x, deviation, roi_coords) for x, deviation in significant_points_pixels]
