...
def detect_and_draw_contours(image, PPMMh_left, PPMMh_center, PPMMh_right):
    """
    ...
    ResizedImage = cv2.resize(image, (960, 540))  # Resize image
...
detect_and_draw_contours(undistorted_img, PPMMh_left, PPMMh_center, PPMMh_right)
